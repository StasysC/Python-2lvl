...
```
Ryšys sukuriamas išorinio rakto - FOREIGN KEY pagalba. Paskutinėje eilutėje nurodoma, kad team_id stulpelis bus išorinis raktas ir referuos į coders lentelės id, kuris turėtų būti pirminis raktas (unikalus indentifikatorius).
